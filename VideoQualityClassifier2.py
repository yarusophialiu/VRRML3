...
# input image 64x64, concatednated decocded and reference patch
...
if __name__ == "__main__":
    ...
    # step1 load data
    dataset = VideoDualPatchDataset(directory=data_train_directory) # len 27592
    test_dataset = VideoDualPatchDataset(directory=data_test_directory) 
